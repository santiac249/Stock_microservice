package com.stock_microservice.stock_microservice.domain.Pagination;
...
public class PageCustom <T>{
    ...
    public <E> PageCustom(List<E> content, int totalElements, int totalPages, int currentPage) {
